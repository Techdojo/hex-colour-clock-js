...
A hex clock being a JavaScript clock where a colour on screen, in this case the page background, corresponds to the current time. For example, 12:00:00am the background would be the colour of #120000.
